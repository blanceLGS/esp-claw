...
export const zhCn: Dict = {
  ...
  voiceAsrSection: '语音 / ASR',
  voiceAsrProvider: '识别引擎',
  voiceAsrEngineHint: '听写适合日常；中英识别大模型准确率/方言更强（需开通 slm）',
  voiceAsrProviderNone: '不启用',
  voiceAsrProviderSiliconFlow: 'SiliconFlow',
  voiceAsrProviderIflytek: '语音听写（流式）',
  voiceAsrProviderIflytekBigmodel: '中英识别大模型',
  voiceAsrApiKey: 'API Key',
  voiceAsrApiSecret: 'API Secret',
  voiceAsrAppId: 'APPID',
  voiceAsrModel: 'ASR 模型',
  voiceAsrModelSiliconFlowHint: '例如 FunAudioLLM/SenseVoiceSmall',
  voiceAsrEndpoint: '接口地址',
  voiceAsrIflytekKeyHint: '讯飞开放平台 APIKey',
  voiceAsrIflytekEndpointHint: '听写：wss://iat-api.xfyun.cn/v2/iat；中英大模型：wss://iat.xf-yun.com/v1',
  voiceAsrEndpointSfHint: '只填 /v1 前缀；运行时自动拼 /audio/transcriptions',
  voiceWakeWords: '唤醒提示词',
  voiceWakeWordsHint: '逗号分隔，例如：小依,你好小依',
  voiceEnable: '常驻语音监听',
  voiceTtsApiKey: 'TTS API Key',
  voiceTtsBaseUrl: 'TTS Base URL',
  voiceTtsBaseUrlHint: '只填 /v1 前缀；运行时自动拼 /audio/speech',
  voiceTtsModel: 'TTS 模型',
  voiceTtsVoice: 'TTS 音色',
  voiceTtsVolume: 'TTS 音量',
  voiceTtsVolumeHint: '0–100，本机喇叭播放音量',
