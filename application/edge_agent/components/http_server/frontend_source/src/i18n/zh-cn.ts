...
export const zhCn: Dict = {
  ...
  voiceAsrIflytekEndpointHint: '讯飞 IAT 只支持 WebSocket，必须填 wss://iat.xf-yun.com/v1，不要填 https://iat-api.xfyun.cn',
