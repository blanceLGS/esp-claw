export const en = {
  ...
  voiceAsrSection: 'Voice / ASR',
  voiceAsrProvider: 'ASR engine',
  voiceAsrEngineHint: 'Dictation for daily use; big model is stronger (requires slm)',
  voiceAsrProviderNone: 'Disabled',
  voiceAsrProviderSiliconFlow: 'SiliconFlow',
  voiceAsrProviderIflytek: 'iFlytek dictation (streaming)',
  voiceAsrProviderIflytekBigmodel: 'iFlytek big model (zh/en)',
  voiceAsrApiKey: 'API Key',
  voiceAsrApiSecret: 'API Secret',
  voiceAsrAppId: 'APPID',
  voiceAsrModel: 'ASR model',
  voiceAsrModelSiliconFlowHint: 'e.g. FunAudioLLM/SenseVoiceSmall',
  voiceAsrEndpoint: 'Endpoint',
  voiceAsrIflytekKeyHint: 'iFlytek console APIKey',
  voiceAsrIflytekEndpointHint: 'Dictation: wss://iat-api.xfyun.cn/v2/iat; big model: wss://iat.xf-yun.com/v1',
  voiceAsrEndpointSfHint: 'Base only (…/v1); runtime appends /audio/transcriptions',
  voiceWakeWords: 'Wake words',
  voiceWakeWordsHint: 'Comma-separated, e.g. 小依,Hello',
  voiceEnable: 'Always-on voice listen',
  voiceTtsApiKey: 'TTS API Key',
  voiceTtsBaseUrl: 'TTS base URL',
  voiceTtsBaseUrlHint: 'Base only (…/v1); runtime appends /audio/speech',
  voiceTtsModel: 'TTS model',
  voiceTtsVoice: 'TTS voice',
  voiceTtsVolume: 'TTS volume',
  voiceTtsVolumeHint: '0–100 local speaker playback volume',
