...
typedef struct {
    ...
    char asr_api_secret[APP_CLAW_STR_LEN];
    char asr_app_id[APP_CLAW_SHORT_STR_LEN];
    ...
    char voice_wake_words[APP_CLAW_STR_LEN];
    char voice_enable[8];
    char tts_api_key[APP_CLAW_STR_LEN];
    char tts_base_url[APP_CLAW_STR_LEN];
    char tts_model[APP_CLAW_MODEL_LEN];
    char tts_voice[APP_CLAW_MODEL_LEN];
    char tts_volume[8];
